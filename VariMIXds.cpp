...
variPacks:
    ...
    cout << "               Varimix is a custom made mix of sweets in one pack\n";
...
receipt:	
    ...
    cout << "\t==>| VariMIX Order Receipt|<== \n";
    
    cout << "\t+============================+\n";
	cout << "\t\tSweets and Bits\n";
...
trans2: 
    ...
    cout << "\t+============================+\n";
	cout << "VariMIX Order Transaction\n"; 
	cout<< "\nTotal Number of Orders: " << 	totalQuantity;
	cout << "\nAmount Per Order: " << "Php " << price;
	cout << "\nTotal Payment: " << "Php " << price * totalQuantity << "\n";
	cout << "VariMIX Order Transaction";  
